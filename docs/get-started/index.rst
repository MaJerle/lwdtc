...
* Clone repository with one of available ``3`` options
  ...
  * Run ``git clone --recurse-submodules --branch master https://github.com/MaJerle/lwdtc`` to clone `latest stable` branch, including submodules
...
List of configuration options are available in the :ref:`api_lwdtc_opt` section.
